...
ActiveRecord::Schema.define(version: 2023_07_25_134959) do
  ...
  create_table "fitness_activities", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_fitness_activities_on_user_id"
  end
  ...
  create_table "reminders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["challenge_id"], name: "index_reminders_on_challenge_id"
  ...
  add_foreign_key "fitness_activities", "users"
  add_foreign_key "notifications", "users"
  add_foreign_key "reminders", "challenges"
